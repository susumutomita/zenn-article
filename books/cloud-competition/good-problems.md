...
良い問題は、参加者に体験してほしい判断を必要とします。さらに、その判断に必要な証拠を環境の中へ置きます。参加者が仮説を立て、証拠を確認し、操作した結果をすぐ観測できることが重要です。

反対に、難しくても学びが残らない問題があります。作者だけが知る隠し場所を当てる問題や、長い手順を正確に写すだけの問題です。これらは、クラウド運用の判断力より、偶然や記憶力を測ってしまいます。
...
| エラーの理由を完全に隠す | ログや状態から原因を絞れるようにする |
...
参加者が新しいEC2やLoad Balancerを手作業で作ると、競技終了後にリソースが残る可能性があります。また、学習目標が「復旧」なのか「構築」なのかも曖昧になります。
...
IAM、VPC、DNS、nginx、APIを同時に壊すと、中心が消えます。総合問題にする場合も、段階を分けて一つずつ発見させます。
...
全てに答えられなくても、最初から巨大な問題を作る必要はありません。中心となる発見を一つ選び、小さなChallengeとして完成させます。その後、Battleで時間圧や再発を追加します。

次章では、本文と実装リポジトリの対応を確認します。その後、学習目標から競技を逆算します。
