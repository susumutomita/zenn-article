...
観察対象は広すぎる可能性があります。前提知識を追加するか、症状から原因を絞れる情報を増やします。

### Hint 3の利用が多い

復旧操作自体は難しい可能性があります。前提Challengeを追加し、Battleの前に基本操作を練習させます。
...
初動の得点は強すぎる可能性があります。後半のフェーズ、復旧bonus、点数配分を見直します。
...
前提知識の差は大きすぎる可能性があります。Challengeで基本操作を分離し、Battle開始時の条件をそろえます。
