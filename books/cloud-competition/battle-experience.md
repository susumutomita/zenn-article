...
Challengeでは、参加者が一つの問題を理解して完了することを重視します。Battleでは、複数チームが同じ時間軸で状態を維持し、再発へ対応します。運営側も、障害注入、全体アナウンス、公平性、観客への見せ方を設計する必要があります。
...
基本操作を理解したチームから次の段階へ進めます。習熟度に応じた演習に向きます。
