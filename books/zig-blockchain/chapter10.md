---
title: "簡易EVM実装（1）スタック・メモリ・ストレージ"
free: true
---
...
ここまでで、256ビット値を扱うスタック、メモリ、ストレージと、基本オペコードを実行するループを実装しました。続く「簡易EVM実装（2）Solidity向けオペコード」でも同じ`book-work/chapter10`を使い、Solidityの関数ディスパッチャーを動かす命令を追加します。
